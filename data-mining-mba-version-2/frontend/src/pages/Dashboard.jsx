  ...
  return (
    <div>
      ...
      <div className="stat-grid">
        <StatCard label="Transactions" value={dsInfo.n_transactions.toLocaleString()} color="cyan" />
        <StatCard label="Unique Items" value={dsInfo.n_items} color="purple" />
        <StatCard label="Avg Basket Size" value={dsInfo.avg_basket_size} color="green" />
        <StatCard label="Iterations Run" value={iterations.length} color="orange" />
        {latestIter && (
          <>
            <StatCard label="Rules (Latest)" value={latestIter.n_rules} color="cyan" />
            <StatCard label="Avg Lift" value={latestIter.avg_lift} color="green" />
          </>
        )}
      </div>
      ...
      <div className="grid-2" style={{ marginBottom: 24 }}>
        ...
        <div className="card">
          ...
          {runLog && (
            <div className="log-box" style={{ marginTop: 14 }}>{runLog}</div>
          )}
        </div>
